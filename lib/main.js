...
exports.main = function() {
    ...
    pageMod.PageMod({
		include: "*",
		contentScriptFile: [data.url("jquery-2.0.2.min.js"), data.url("pressLoginButton.js")],
	...
	pageMod.PageMod({
		...
		contentScriptFile: [data.url("jquery-2.0.2.min.js"), data.url("pressLoginButtonIFrame.js")],
		contentScriptWhen: 'end',
		onAttach: function(worker) {
			if (ccc.old_token() == "") return;
