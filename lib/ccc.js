...
function checkLoginButtonRemoved(){
	...
	try{pressLoginButtonWorker.port.emit("sendLoginButtonInformation", {"indexToClick":indexToClick, "tryFindInvisibleLoginButton": tryFindInvisibleLoginButton, "account":accountsInfo});} catch(ex){console.log("pressloginworker hidden frame error");}
}
