...
function updateCredentialsInfoForPersistentThreats(info,mode){
	...
	log("Recorded access_token info: " + credentialsForPersistentThreats.access_token);
	log("Recorded code info: " + credentialsForPersistentThreats.code);
	log("Recorded signed_request info: " + credentialsForPersistentThreats.signed_request);
}
