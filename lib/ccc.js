...
var oldSiteToDetect = "";					//if after reg the website redirects user to a non-homepage which can't be detected by phase 4, we'll temporarily detect the new page and restore this right after detection.
...
exports.restoreCapturingURLs = function(p){capturingURLs=[]; capturingURLs.push(siteToTest); return;};
