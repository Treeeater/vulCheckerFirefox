...
function updateCredentialsInfoForPersistentThreats(info,mode){
	...
	console.log(credentialsForPersistentThreats.access_token);
	console.log(credentialsForPersistentThreats.code);
	console.log(credentialsForPersistentThreats.signed_request);
}
