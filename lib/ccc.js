...
function testSuitePhase10(url){
	...
	checkToken(storageRecord[siteToTest]);
	//testSuitePhase11();
}
...
TracingListener.prototype =
{
    ...
    onStopRequest: function(request, context, statusCode)
    {
		...
		//if (true)
		{
			...
			//if (url.indexOf("https://www.facebook.com/dialog/permissions")!=-1) 
			responseRecord.body = responseBody.substr(0,400);				//now only record 200 characters
