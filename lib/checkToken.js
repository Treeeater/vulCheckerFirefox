...
var checkToken = function(storageRecord)
{
	...
	if (!ccc.usedFBSDK()) res = storageRecord.facebookDialogOAuthResponse.url;		//means the app didn't use the SDK, which means the acutal redirect url is in the 302 url, as opposed to javascript content.
	ccc.log(res);
