...
text2.each_line do |line|
	...
	if ((hash[siteURL])[1] != "" && (hash[siteURL])[1] != nil && tempArray[2] != "" && tempArray[2] != nil && (hash[siteURL])[1] != tempArray[2]) 
		...
		p siteURL + " changed to vulnerable on disagreement for 2"
		hash[siteURL][1] = -1
	end
	...
	if ((hash[siteURL])[4] != "" && (hash[siteURL])[4] != nil && tempArray[5] != "" && tempArray[5] != nil && (hash[siteURL])[4] != tempArray[5].chomp) 
		#Disagreement here is fine, we probably didn't see that in one try. Mark it vulnerable
	...
	if ((hash[siteURL])[4] == "" || (hash[siteURL])[4] == nil) then (hash[siteURL])[4] = tempArray[5] end
end
